...
# На основании построенных графиков, делаем вывод, что модель логистической регрессии лучше, 
# поскольку прощадь под ROC кривой на тестовой выборке у неё больше, чем у модели LDA.
